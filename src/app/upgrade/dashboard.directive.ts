...
export class DashboardDirective extends UpgradeComponent implements OnInit, OnChanges, DoCheck, OnDestroy {
  
  @Input('ng1Data' /* aliases are not working */) ng1Data: any;
  @Output('ng1Event' /* aliases are not working */) ng1Event: EventEmitter<any>;

  constructor(elementRef: ElementRef, injector: Injector) {
    
    // AngularJs component "ng1Home" must exist!
    super('ng1-dashboard', elementRef, injector);
